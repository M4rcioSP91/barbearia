...
//CRUD
class adicionarFuncionarioService{
...
public function __construct(conexao $conexao,novoCadastro $cadastro){//recebe a conexaõ e o objeto serviço
    ...
    public function inserir(){ // create
       ...
       try {
        ...
        VALUES (:nome, :sobrenome, :email, :senha, :telefone, 1, 2, :nomeEmpresa)';
        ...
        $stmt2->bindValue(':funcao', $this->cadastro->__get('funcao') ?? 'Cabeleireiro');
        $stmt2->execute();
