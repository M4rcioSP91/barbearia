<? 
	require 'auth.php';
	require "minhaConta_controller.php";
						...
						<div class="row">
							<div class="col">
								...
								<div class="input-group mb-3">
									...
									<form class="row g-3" method="post" action="atualizar_conta_controller.php">

									<div class="col-md-8" style="margin-bottom: 2em">
										<input type="text" name="nome" class="form-control" value="<?= htmlspecialchars($dadosUsuario->nome) ?>">
									</div>	
									

									<div class="col-md-8" style="margin-bottom: 2em">
										<input type="text" name="sobrenome" class="form-control" value="<?= htmlspecialchars($dadosUsuario->sobrenome) ?>">										
									</div>
									

									<div class="col-md-8" style="margin-bottom: 2em">										
										<input type="text" name="nomeEmpresa" class="form-control" value="<?= htmlspecialchars($dadosUsuario->nomeEmpresa) ?>">								
									</div>									
									

									<div class="col-md-8" style="margin-bottom: 2em">
										<input type="text" name="email" class="form-control" value="<?= htmlspecialchars($dadosUsuario->email) ?>">										
									</div>
									

									<div class="col-md-8" style="margin-bottom: 2em">
										<input type="text" name="telefone" class="form-control" value="<?= htmlspecialchars($dadosUsuario->telefone) ?>">
										</div>
